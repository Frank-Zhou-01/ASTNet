...
class Encoder_shift_block(nn.Module):
    def __init__(self, n_features, kernel_size, reduction, bias=False, scale_unetfeats=48):
        ...
        self.encoder_level1_3 = [CAB2(n_feat, 5, reduction, bias=bias, act=act, add_channel=8 * self.number),
                                 CAB1(n_feat, 5, reduction, bias=bias, act=act)]
        self.encoder_level1_4 = [CAB2(n_feat, 5, reduction, bias=bias, act=act, add_channel=8 * self.number),
                                 CAB1(n_feat, 5, reduction, bias=bias, act=act)]
        self.encoder_level1_5 = [CAB2(n_feat, 5, reduction, bias=bias, act=act, add_channel=8 * self.number),
                                 CAB1(n_feat, 5, reduction, bias=bias, act=act)]
        self.encoder_level1_6 = [CAB2(n_feat, 5, reduction, bias=bias, act=act, add_channel=8 * self.number),
                                 CAB1(n_feat, 5, reduction, bias=bias, act=act)]
        self.encoder_level1_7 = [CAB2(n_feat, 5, reduction, bias=bias, act=act, add_channel=8 * self.number),
                                 CAB1(n_feat, 5, reduction, bias=bias, act=act)]
        self.encoder_level1 = nn.Sequential(*self.encoder_level1)
...
class GShiftNet(nn.Module):
    ...
    def __init__(self, n_features=48, future_frames=1, past_frames=1):
        ...
        self.orb1 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                             scale_unetfeats=0)
        self.orb2 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                             scale_unetfeats=0)
        self.orb3 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                             scale_unetfeats=0)
        # self.orb4 = 
        self.orb4 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                             scale_unetfeats=0)
        self.orb5 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                             scale_unetfeats=0)
        self.rorb1 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                              scale_unetfeats=0)
        self.rorb2 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                              scale_unetfeats=0)
        self.rorb3 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                              scale_unetfeats=0)
        # self.orb4 = 
        self.rorb4 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                              scale_unetfeats=0)
        self.rorb5 = TFR_UNet(self.n_feats0, self.n_feats, kernel_size=3, reduction=4, act=nn.PReLU(), bias=False,
                              scale_unetfeats=0)
    ...
    def forward(self, x, k1=None, k2=None, k3=None):
        ...
        output_features = self.stage2(x0[self.num_fb:frames - self.num_ff],
