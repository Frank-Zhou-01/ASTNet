...
class TurtleAttnBlock(nn.Module):
    def __init__(self, dim, ffn_expansion_factor, bias, LayerNorm_type, num_heads=1, Scale_patchsize=1,
                 attention_type='channel', FFW_type="GFFW", num_frames_tocache=1, plot_attn=False):
...
class LevelBlock(nn.Module):
    def __init__(self, dim, ffn_expansion_factor, bias, LayerNorm_type, num_blocks,
        ...
        Block_list.append(TurtleAttnBlock(dim=dim, num_heads=num_heads,
                                          ...
                                          num_frames_tocache=num_frames_tocache, Scale_patchsize=Scale_patchsize))
...
class LatentCacheBlock(nn.Module):
    def __init__(self, dim, ffn_expansion_factor, bias, LayerNorm_type, num_blocks,
        ...
        Block_list.append(TurtleAttnBlock(dim=dim, num_heads=num_heads,
                                          ...
                                          num_frames_tocache=num_frames_tocache, plot_attn=True))
...
class Turtle_t1(nn.Module):
    def __init__(self,
                 ...
                 encoder1_attn_type1='ReducedAttn', encoder1_attn_type2='ReducedAttn',
                 encoder2_attn_type1='ReducedAttn', encoder2_attn_type2='ReducedAttn',
                 encoder3_attn_type1='Channel', encoder3_attn_type2='Channel',

                 # Decoder attention types
                 decoder1_attn_type1='Channel', decoder1_attn_type2='CHM',
                 decoder2_attn_type1='Channel', decoder2_attn_type2='CHM',
                 decoder3_attn_type1='Channel', decoder3_attn_type2='CHM',

                 # FFW types for each encoder and decoder level
                 encoder1_ffw_type='FFW', encoder2_ffw_type='FFW', encoder3_ffw_type='GFFW',
                 decoder1_ffw_type='GFFW', decoder2_ffw_type='GFFW', decoder3_ffw_type='GFFW',

                 # Latent
                 latent_attn_type1='FHR', latent_attn_type2='Channel', latent_attn_type3='FHR', latent_ffw_type='GFFW',

                 # Refinement
                 refinement_attn_type1='ReducedAttn', refinement_attn_type2='ReducedAttn', refinement_ffw_type='GFFW',

                 use_both_input=False,
                 num_frames_tocache=3):
        super(Turtle_t1, self).__init__()
        if use_both_input:
            inp_channels *= 2
