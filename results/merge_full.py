...
restoration_name = 'GOPRO-ASTNetL'        # saved root in your testing yaml(e.g. first line of test_Deblur_GOPRO.yml)
...
root = './' + restoration_name + f'/visualization/{dataset_name}/'
now_video = 0
id = 0
frame_len = 0
