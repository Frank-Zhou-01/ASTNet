...
y = [34.35, 34.50, 34.57, 34.61, 34.64, 34.66, 34.66]
...
# 设置坐标轴标签
plt.xlabel('Video Length (frame)', fontsize=30, labelpad=10)
plt.ylabel('PSNR (dB)', fontsize=30, labelpad=10)
...
plt.yticks(np.arange(34.0, 34.7, 0.1), fontsize=20)
